...
void loop() {
  ...
  Serial.print((float)counter/2048);
  Serial.print("\tFeet: ");
  Serial.print(rotationsToFeet((float)counter/2048));
  Serial.print("\tFPM: ");
  Serial.println(feetPerMinute(rotationsToFeet((float)counter/2048)));
...
float feetPerMinute(float feet){
  return feet / ((millis()-startTime)/60000);  
}
